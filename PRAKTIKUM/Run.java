...
public class Run{
    public static void main(String[] args) {
        ...
        student1.setFirstName("Muh. Taufiq");
        student1.setLastName("Arifin");
        ...
        student3.setFirstName("Ayu Farah Diba");
        student3.setLastName("Hamzah");
